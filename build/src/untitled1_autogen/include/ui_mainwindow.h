...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy2.setHeightForWidth(check_btn->sizePolicy().hasHeightForWidth());
        check_btn->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(inperrline->sizePolicy().hasHeightForWidth());
        inperrline->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(wrerrorline->sizePolicy().hasHeightForWidth());
        wrerrorline->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(fsline->sizePolicy().hasHeightForWidth());
        fsline->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(freeline->sizePolicy().hasHeightForWidth());
        freeline->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(writtenline->sizePolicy().hasHeightForWidth());
        writtenline->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(inperrline_2->sizePolicy().hasHeightForWidth());
        inperrline_2->setSizePolicy(sizePolicy3);
        ...
        sizePolicy5.setHeightForWidth(testProgress->sizePolicy().hasHeightForWidth());
        testProgress->setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(setframe->sizePolicy().hasHeightForWidth());
        setframe->setSizePolicy(sizePolicy6);
        ...
        sizePolicy2.setHeightForWidth(accept_btn->sizePolicy().hasHeightForWidth());
        accept_btn->setSizePolicy(sizePolicy2);
        ...
        gridLayout->addWidget(accept_btn, 2, 0, 1, 1);
        ...
        sizePolicy5.setHeightForWidth(fcount_b->sizePolicy().hasHeightForWidth());
        fcount_b->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(fsize_b->sizePolicy().hasHeightForWidth());
        fsize_b->setSizePolicy(sizePolicy5);
        ...
        gridLayout->addLayout(settgrid, 1, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        main_page->setToolTip(QApplication::translate("MainWindow", "\320\223\320\273\320\260\320\262\320\275\320\260\321\217", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        exit->setToolTip(QApplication::translate("MainWindow", "\320\222\321\213\321\205\320\276\320\264", 0));
#endif // QT_NO_TOOLTIP
        exit->setShortcut(QApplication::translate("MainWindow", "F9", 0));
        logging->setText(QApplication::translate("MainWindow", "\320\226\321\203\321\200\320\275\320\260\320\273 F7", 0));
#ifndef QT_NO_TOOLTIP
        logging->setToolTip(QApplication::translate("MainWindow", "\320\226\321\203\321\200\320\275\320\260\320\273 \321\202\320\265\321\201\321\202\320\260", 0));
#endif // QT_NO_TOOLTIP
